...
<main>
    ...
    /** @var int $studentId */
    $result = $studentModel->getGradeByStudentId($studentId);
...
//    $result = $courseModel->getAllCourse();
    ...
    foreach ($result as $course) {
        ...
        echo "<tr>
                    ...
                    <td style='white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 300px;'>" . $course['credits'] . "</td>
                    <td>" . $courseModel->getGradeByStudentIdAndCourseId($studentId,$courseId) . "</td>
                  </tr>";
    }
    echo "</tbody></table>";
